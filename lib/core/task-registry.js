...
const detectDuplicateCode = require('../tasks/common/duplicate-code-detector');
const eliminateDeadCode = require('../tasks/common/dead-code-eliminator');
const analyzeComplexity = require('../tasks/common/complexity-analyzer');
const optimizePerformance = require('../tasks/common/performance-optimizer');

// Import JavaScript/TypeScript tasks
const detectUnusedDependencies = require('../tasks/javascript/unused-dependencies');
const formatCode = require('../tasks/javascript/code-formatter');
  ...
  constructor() {
    this.tasks = {
      ...
      common: [
        ...
        {
          id: 'detect-duplicate-code',
          name: 'Detect duplicate code',
          description: 'Identifies duplicated code blocks across the project and suggests refactoring',
          taskFn: detectDuplicateCode,
          applicableToTypes: ['all']
        },
        {
          id: 'eliminate-dead-code',
          name: 'Eliminate dead code',
          description: 'Detects and suggests removal of unused code (dead code)',
          taskFn: eliminateDeadCode,
          applicableToTypes: ['all']
        },
        {
          id: 'analyze-complexity',
          name: 'Analyze code complexity',
          description: 'Analyzes code complexity and provides simplification recommendations',
          taskFn: analyzeComplexity,
          applicableToTypes: ['all']
        },
        {
      ...
      javascript: [
        ...
        },
        {
          id: 'format-code',
          name: 'Format code',
          description: 'Formats JavaScript/TypeScript code according to best practices',
          taskFn: formatCode,
          applicableToTypes: ['javascript', 'typescript']
        }
      ],
